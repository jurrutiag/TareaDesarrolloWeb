...
var comunas_regiones = {};
comunas_regiones['Región de Tarapacá'] = ['Iquique', 'Alto Hospicio', 'Pozo Almonte', 'Camiña', 'Colchane', 'Huara', 'Pica'];
comunas_regiones['Región de Antofagasta'] = ['Antofagasta', 'Mejillones', 'Sierra Gorda', 'Taltal', 'Calama', 'Ollague', 'San Pedro De Atacama', 'Tocopilla', 'Maria Elena'];
comunas_regiones['Región de Atacama'] = ['Copiapo', 'Caldera', 'Tierra Amarilla', 'Chañaral', 'Diego De Almagro', 'Vallenar', 'Alto Del Carmen', 'Freirina', 'Huasco'];
comunas_regiones['Región de Coquimbo'] = ['La Serena', 'Coquimbo', 'Andacollo', 'La Higuera', 'Paiguano', 'Vicuña', 'Illapel', 'Canela', 'Los Vilos', 'Salamanca', 'Ovalle', 'Combarbala', 'Monte Patria', 'Punitaqui', 'Rio Hurtado'];
comunas_regiones['Región de Valparaíso'] = ['Valparaiso', 'Casablanca', 'Concon', 'Juan Fernandez', 'Puchuncavi', 'Quintero', 'Viña Del Mar', 'Isla De Pascua', 'Los Andes', 'Calle Larga', 'Rinconada', 'San Esteban', 'La Ligua', 'Cabildo', 'Papudo', 'Petorca', 'Zapallar', 'Quillota', 'Calera', 'Hijuelas', 'La Cruz', 'Nogales', 'San Antonio', 'Algarrobo', 'Cartagena', 'El Quisco', 'El Tabo', 'Santo Domingo', 'San Felipe', 'Catemu', 'Llaillay', 'Panquehue', 'Putaendo', 'Santa Maria', 'Quilpue', 'Limache', 'Olmue', 'Villa Alemana'];
comunas_regiones['Región del Libertador Gral. Bernardo O’Higgins'] = ['Rancagua', 'Codegua', 'Coinco', 'Coltauco', 'Doñihue', 'Graneros', 'Las Cabras', 'Machali', 'Malloa', 'Mostazal', 'El Olivar', 'Peumo', 'Pichidegua', 'Quinta De Tilcoco', 'Rengo', 'Requinoa', 'San Vicente', 'Pichilemu', 'La Estrella', 'Litueche', 'Marchihue', 'Navidad', 'Paredones', 'San Fernando', 'Chepica', 'Chimbarongo', 'Lolol', 'Nancagua', 'Palmilla', 'Peralillo', 'Placilla', 'Pumanque', 'Santa Cruz'];
comunas_regiones['Región del Maule'] = ['Talca', 'Constitución', 'Curepto', 'Empedrado', 'Maule', 'Pelarco', 'Pencahue', 'Rio Claro', 'San Clemente', 'San Rafael', 'Cauquenes', 'Chanco', 'Pelluhue', 'Curicó', 'Hualañe', 'Licantén', 'Molina', 'Rauco', 'Romeral', 'Sagrada Familia', 'Teno', 'Vichuquén', 'Linares', 'Colbún', 'Longaví', 'Parral', 'Retiro', 'San Javier', 'Villa Alegre', 'Yerbas Buenas'];
comunas_regiones['Región del Ñuble'] = ["Cobquecura", "Coelemu", "Ninhue", "Portezuelo", "Quirihue", "Ránquil", "Treguaco", "Bulnes", "Chillán Viejo", "Chillán", "El Carmen", "Pemuco", "Pinto", "Quillón", "San Ignacio", "Yungay", "Coihueco", "Ñiquén", "San Carlos", "San Fabián", "San Nicolás"];
comunas_regiones['Región del BioBío'] = ["Concepción", "Coronel", "Chiguayante", "Florida", "Hualqui", "Lota", "Penco", "San Pedro de la Paz", "Santa Juana", "Talcahuano", "Tomé", "Hualpén", "Lebu", "Arauco", "Cañete", "Contulmo", "Curanilahue", "Los Álamos", "Tirúa", "Los Ángeles", "Antuco", "Cabrero", "Laja", "Mulchén", "Nacimiento", "Negrete", "Quilaco", "Quilleco", "San Rosendo", "Santa Bárbara", "Tucapel", "Yumbel", "Alto Biobío"];
comunas_regiones['Región de la Araucanía'] = ["Temuco", "Carahue", "Cunco", "Curarrehue", "Freire", "Galvarino", "Gorbea", "Lautaro", "Loncoche", "Melipeuco", "Nueva Imperial", "Padre las Casas", "Perquenco", "Pitrufquén", "Pucón", "Saavedra", "Teodoro Schmidt", "Toltén", "Vilcún", "Villarrica", "Cholchol", "Angol", "Collipulli", "Curacautín", "Ercilla", "Lonquimay", "Los Sauces", "Lumaco", "Purén", "Renaico", "Traiguén", "Victoria"];
comunas_regiones['Región de los Lagos'] = ['Puerto Montt', 'Calbuco', 'Cochamó', 'Fresia', 'Frutillar', 'Los Muermos', 'Llanquihue', 'Maullín', 'Puerto Varas', 'Castro', 'Ancud', 'Chonchi', 'Curaco de Velez', 'Dalcahue', 'Puqueldón', 'Queilén', 'Quellón', 'Quemchi', 'Quinchao', 'Osorno', 'Puerto Octay', 'Purranque', 'Puyehue', 'Rio Negro', 'San Juan de la Costa', 'San Pablo', 'Chaitén', 'Futaleufú', 'Hualaihue', 'Palena'];
comunas_regiones['Región Aysén del Gral. Carlos Ibáñez del Campo'] = ['Coihayque', 'Lago Verde', 'Aisén', 'Cisnes', 'Guaitecas', 'Cochrane', "O'Higgins", 'Tortel', 'Chile Chico', 'Rio Ibáñez'];
comunas_regiones['Región de Magallanes y de la Antártica Chilena'] = ['Punta Arenas', 'Laguna Blanca', 'Rio Verde', 'San Gregorio', 'Cabo de Hornos', 'Antártica', 'Porvenir', 'Primavera', 'Timaukel', 'Natales', 'Torres del Paine'];
comunas_regiones['Región Metropolitana de Santiago'] = ["Santiago", "Cerrillos", "Cerro Navia", "Conchalí", "El Bosque", "Estación Central", "Huechuraba", "Independencia", "La Cisterna", "La Florida", "La Granja", "La Pintana", "La Reina", "Las Condes", "Lo Barnechea", "Lo Espejo", "Lo Prado", "Macul", "Maipú", "Ñuñoa", "Pedro Aguirre Cerda", "Peñalolén", "Providencia", "Pudahuel", "Quilicura", "Quinta Normal", "Recoleta", "Renca", "San Joaquín", "San Miguel", "San Ramón", "Vitacura", "Puente Alto", "Pirque", "San José de Maipo", "Colina", "Lampa", "Tiltil", "San Bernardo", "Buin", "Calera de Tango", "Paine", "Melipilla", "Alhué", "Curacaví", "Maria Pinto", "San Pedro", "Talagante", "El Monte", "Isla de Maipo", "Padre Hurtado", "Peñaflor"]
comunas_regiones['Región de los Rios'] = ['Valdivia', 'Corral', 'Lanco', 'Los Lagos', 'Máfil', 'Mariquina', 'Paillaco', 'Panguipulli', 'La Unión', 'Futrono', 'Lago Ranco', 'Rio Bueno'];
comunas_regiones['Región de Arica y Parinacota'] = ['Arica', 'Camarones', 'Putre', 'General Lagos'];

/*
var info_viajes = [
    {"region-origen": "Region de Tarapaca", "comuna-origen": "Iquique", "region-destino": "Region Metropolitana de Santiago", "comuna-destino": "Santiago", "fecha-viaje": "26/11/2018", "espacio-disponible": "20x20x20", "kilos-disponibles": "2kg", "email-viajero": "j.urrutia@gmail.com", "celular-viajero": "+56998541389"},
    {"region-origen": "Region Aysén del Gral. Carlos Ibáñez del Camp", "comuna-origen": "Lago Verde", "region-destino": "Region Metropolitana de Santiago", "comuna-destino": "Estación Central", "fecha-viaje": "25/09/2019", "espacio-disponible": "30x30x30", "kilos-disponibles": "1kg", "email-viajero": "ronaldo@gmail.com", "celular-viajero": "+56983941750"},
    {"region-origen": "Region Metropolitana de Santiago", "comuna-origen": "Huechuraba", "region-destino": "Region de Magallanes y de la Antártica Chilena", "comuna-destino": "Punta Arenas", "fecha-viaje": "15/12/2018", "espacio-disponible": "20x20x20", "kilos-disponibles": "500gr", "email-viajero": "miguel@gmail.com", "celular-viajero": "+56982465701"},
    {"region-origen": "Region de los Rios", "comuna-origen": "Valdivia", "region-destino": "Region de Arica y Parinacota", "comuna-destino": "Arica", "fecha-viaje": "01/01/2019", "espacio-disponible": "30x30x30", "kilos-disponibles": "1.5kg", "email-viajero": "martin@gmail.com", "celular-viajero": "+56992636182"},
    {"region-origen": "Region del BioBío", "comuna-origen": "Concepción", "region-destino": "Region de Antofagasta", "comuna-destino": "Antofagasta", "fecha-viaje": "10/11/2018", "espacio-disponible": "10x10x10", "kilos-disponibles": "800gr", "email-viajero": "graciela@gmail.com", "celular-viajero": "+56972831812"}
];
*/


/*var info_encargos = [
    {"descripcion": "Notebook Dell XPS 12", "espacio-solicitado": "10x10x10", "kilos-solicitados": "1kg", "region-origen": "Region de Tarapaca", "comuna-origen": "Iquique", "region-destino": "Region Metropolitana de Santiago", "comuna-destino": "Santiago", "foto-encargo": "Resized pictures - 1.jpg", "email-encargador": "j.urrutia@gmail.com", "celular-encargador": "+56998541389"},
    {"descripcion": "Tablet Galaxy Tab S2", "espacio-solicitado": "10x10x10", "kilos-solicitados": "800gr", "region-origen": "Region de Arica y Parinacota", "comuna-origen": "Camarones", "region-destino": "Region de Magallanes y de la Antártica Chilena", "comuna-destino": "Punta Arenas", "foto-encargo": "20180927_010630-756x1008.jpg", "email-encargador": "miguel@gmail.com", "celular-encargador": "+56954364978"},
    {"descripcion": "Funda Tablet", "espacio-solicitado": "10x10x10", "kilos-solicitados": "200gr", "region-origen": "Region de Los Rios", "comuna-origen": "Corral", "region-destino": "Region del Maule", "comuna-destino": "Constitución", "foto-encargo": "Resized pictures - 1 (1).jpg", "email-encargador": "asdasd@hotmail.com", "celular-encargador": "+56978954126"},
    {"descripcion": "Lampara de escritorio", "espacio-solicitado": "20x20x20", "kilos-solicitados": "1kg", "region-origen": "Region de Atacama", "comuna-origen": "Caldera", "region-destino": "Region de Los Lagos", "comuna-destino": "Calbuco", "foto-encargo": "20181006_212706-756x1008.jpg", "email-encargador": "martin.q@gmail.com", "celular-encargador": "+56945698712"},
    {"descripcion": "Calefactor eléctrico", "espacio-solicitado": "30x30x30", "kilos-solicitados": "1.5kg", "region-origen": "Region Metropolitana de Santiago", "comuna-origen": "Santiago", "region-destino": "Region del Libertador Gral. Bernardo O’Higgins", "comuna-destino": "Rancagua", "foto-encargo": "20181006_212715-756x1008.jpg", "email-encargador": "jano.w@hotmail.com", "celular-encargador": "+56974152468"}
];
*/
...
function comunaOrigen() {
    ...
    for(var i = 0; i < comuna_regiones_dict[regionOrigen.value].length; i++) {
        ...
        //opt.value = comunas_regiones[regionOrigen.value][i];
        //opt.textContent = comunas_regiones[regionOrigen.value][i];
...
function comunaDestino() {
    ...
    for(var i = 0; i < comuna_regiones_dict[regionDestino.value].length; i++) {
        var opt = document.createElement("option");
        //opt.value = comunas_regiones[regionDestino.value][i];
        //opt.textContent = comunas_regiones[regionDestino.value][i];
...
function generateTable(type) {
    ...
    if (type == 'viajes') {
        info = info_viajes;
        cols = ["origen", "destino", "fecha-viaje", "espacio-disponible", "kilos-disponibles", "email-viajero"];

    } else if (type == 'encargos') {
        info = info_encargos;
        cols = ["origen", "destino", "foto-encargo", "espacio-solicitado", "kilos-solicitados", "email-encargador"];
    }
    ...
    for (var i = 0; i < info.length; i++) {
        ...
        tr.id = i;
        if (type == 'viajes') {
            tr.onclick = function () {masInfoViajes(this.id);};
        } else if (type == 'encargos') {
            tr.onclick = function () {masInfoEncargos(this.id);};
        }
        for (var j = 0; j < cols.length; j++) {
            var td = document.createElement("td");

            if (cols[j] == "foto-encargo") {
                var img = document.createElement("img");
                img.alt = "Foto encargo " + i;
                img.src = "../fotos/" + info[i][cols[j]];
                img.className = "foto-tabla";
                td.appendChild(img);

            } else if (cols[j] == "origen" || cols[j] == "destino") {
                td.textContent = info[i]["comuna-" + cols[j]] + "/" + info[i]["region-" + cols[j]];

            } else {
                td.textContent = info[i][cols[j]];
...
function validarFecha(dat) {
    ...
    // rangos
    if (mes > 12 || mes <= 0 || anio > 5000 || anio < 2018 || dia <= 0) {
        return false;
    }
...
function validarSelect(id, isValid) {
    ...
    if (select.selectedIndex <= -1) {
        isValid = false;
        if (!document.getElementById(id + "-h").innerHTML.includes(" (Ingrese una opción)")) {
            document.getElementById(id + "-h").innerHTML += " (Ingrese una opción)";
...
function validarEmail(isValid) {
    ...
    if (!/(?:[a-z0-9!#$%&'*+/=?^_`{|}~-]+(?:\.[a-z0-9!#$%&'*+/=?^_`{|}~-]+)*|"(?:[\x01-\x08\x0b\x0c\x0e-\x1f\x21\x23-\x5b\x5d-\x7f]|\\[\x01-\x09\x0b\x0c\x0e-\x7f])*")@(?:(?:[a-z0-9](?:[a-z0-9-]*[a-z0-9])?\.)+[a-z0-9](?:[a-z0-9-]*[a-z0-9])?|\[(?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\.){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?|[a-z0-9-]*[a-z0-9]:(?:[\x01-\x08\x0b\x0c\x0e-\x1f\x21-\x5a\x53-\x7f]|\\[\x01-\x09\x0b\x0c\x0e-\x7f])+)\])/.test(mail)) {
        isValid = false;
        if (!document.getElementById("email-h").innerHTML.includes(" (Ingrese un mail válido)")) {
            document.getElementById("email-h").innerHTML += " (Ingrese un mail válido)";
...
function validarCelular(isValid) {
    ...
    if (!/^\+56\d{1}\d{8}/.test(celular)) {
        isValid = false;
        if (!document.getElementById("celular-h").innerHTML.includes(" (Ingrese número de celular válido)")) {
            document.getElementById("celular-h").innerHTML += " (Ingrese número de celular válido)";
            document.getElementById("celular-h").style.color = "red";
        }
    }  else {
...
function validarDescripcion(isValid) {
    ...
    if (descripcion.length > maxCaracteres) {
        isValid = false;
        if (!document.getElementById("descripcion-h").innerHTML.includes(" (Ingrese descripción válida)")) {
            document.getElementById("descripcion-h").innerHTML += " (Ingrese descripción válida)";
            document.getElementById("descripcion-h").style.color = "red";
        }
    }  else {
...
function validarFoto(isValid) {
    ...
    console.log(splFoto[splFoto.length - 1])
    if (foto.length <= 0 || !isin(splFoto[splFoto.length - 1].toLowerCase(), extensiones)) {
        isValid = false;
        if (!document.getElementById("foto-encargo-h").innerHTML.includes(" (Ingrese archivo válido)")) {
            document.getElementById("foto-encargo-h").innerHTML += " (Ingrese archivo válido)";
            document.getElementById("foto-encargo-h").style.color = "red";
        }
    }  else {
